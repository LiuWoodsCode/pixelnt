...
Language=English
A system file that is owned by PixelNT was replaced by an application
...
has prevented PixelNT from operating.  You can determine which component is
...
hardware problem thereby allowing PixelNT to operate.
.
